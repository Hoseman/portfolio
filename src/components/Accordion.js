...
function Accordion() {
  const [items, setItems] = useState([
    ...
    },
    {
      ...
      content_title_2: 'Project Overview',
      content_2: 'The client owned an old website with a database of 8000 yew tree entries. The brief was to rebuild the website as a responsive Wordpress custom bespoke theme and then execute the data migration into Wordpress and then build a comprehensive search feature and interative map.',
